	...
	private void initialize() {
		...
		B_signup.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				String DBConnection = "INSERT members VALUES(" + t_SName + ", '" + t_SId + "'," + t_Password + "')";
				
				if(!(t_SName.equals("") && t_SId.equals("") && t_Password.equals(""))) {
				
				}
				
				if(bnt_DoubleCheck.equals("중복")) {
				...
				B_NLogin.addActionListener(new ActionListener() {//비회원
				...
				B_Login.addActionListener(new ActionListener() {//회원
					// 만들어진 버튼 "새 창 띄우기"에 버튼이 눌러지면 발생하는 행동을 정의
					@Override
					public void actionPerformed(ActionEvent e) {
						Buy_Time b = new Buy_Time();
				...
				B_signup.addActionListener(new ActionListener() {//회원가입
					// 만들어진 버튼 "새 창 띄우기"에 버튼이 눌러지면 발생하는 행동을 정의
					@Override
					public void actionPerformed(ActionEvent e) {
						Buy_Time b = new Buy_Time();
